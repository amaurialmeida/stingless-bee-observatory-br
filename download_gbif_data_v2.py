...
def download_meliponini_data():
    ...
    # Se municipality não existir, criar uma coluna vazia ou usar stateProvince
    if 'municipality' not in df_clean.columns:
        df_clean['municipality'] = df_clean.get('stateProvince', 'Desconhecido')
